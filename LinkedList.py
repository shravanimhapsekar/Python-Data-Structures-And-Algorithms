...
5
Popped Element: 5
Prepend element is 1.
0
1
2
3
4
First element has been popped!
1
2
3
4
Enter the index no. to fetch value from: 2
Value at index 2 is 3
Enter the index no. at which you want to set value: 5
Invalid index. Cannot set value.
Enter the index no. at which you want to set value: 4
Invalid index. Cannot set value.
Enter the index no. at which you want to set value: 3
Enter the value you want to set: 44
Value at index 3 updated to 44
1
2
3
44
Enter the index no. at which you want to insert value: 5
Not a valid index. Please try again.
Enter the index no. at which you want to insert value: 4
Enter the value you want to insert: 5
Value 5 inserted at index 4
1
2
3
44
5
Enter the index of the node to remove: 3
Node with value 44 removed from index 3
